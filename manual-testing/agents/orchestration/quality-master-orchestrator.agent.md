...
**Read** `manual-testing/skills/tc-formatter-bdd.md` when `testStyle` includes `"bdd"`:
- Input: `01-scenarios/` + `03-gap-filled/` (if exists)
- Output: `manual-tcs/bdd/<feature-name>.feature` — properly tagged per kit BDD rules

**Read** `manual-testing/skills/tc-formatter-nonbdd.md` when `testStyle` includes `"nonbdd"`:
...
| Phase | Agent file |
|-------|-----------|
| 0 | `manual-testing/agents/analysis/user-story-analyzer.agent.md` |
| 1 | `manual-testing/agents/orchestration/quality-orchestrator.agent.md` |
| 2 | `manual-testing/agents/orchestration/quality-evaluator.agent.md` |
| 3 | `manual-testing/agents/analysis/gap-filler.agent.md` |
| 4 | `manual-testing/skills/tc-formatter-bdd.md` + `manual-testing/skills/tc-formatter-nonbdd.md` |
