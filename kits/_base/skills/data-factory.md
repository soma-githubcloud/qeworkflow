...
equivalence partitioning. Load this into the `datagen-agent` for all fixture generation tasks.
...
The `overrides` pattern is critical — it lets tests fix specific fields while keeping others random.
