...
`bdd-agent` before feature file generation.
...
If no mapping exists for a phrase, apply this rule:
- Strip "click" → convert target to noun phrase: "click <X> button" → "they select <X>"
- Strip "fill" → "they provide <field-name>": "fill email field" → "they provide their email"
...
4. Always add: `@ui` for UI kits (Kit-U1/U2/U3/U4/H1/H2/H3)
...
This minimizes step definition file size and maximizes reuse.
