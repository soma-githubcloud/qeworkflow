...
Use `kits/_base/skills/gherkin-transformer.md` to convert each test case's steps into Given/When/Then sequences.
...
4. Apply `.claude/rules/bdd-gherkin.md` rules — validate one assertion per Then, no UI verbs in strict mode
