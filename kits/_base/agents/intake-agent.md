...
[
  { "pageName": "HomePage",          "file": "snapshots/amazonHome-page.html" },
  { "pageName": "SearchResultsPage", "file": "snapshots/amazonSearch-page.html" }
]

// Single file (legacy / backward-compatible):
"snapshots/amazonHome-page.html"

// Also accepted: comma-separated string of paths (auto-assigns pageNames from filename):
"snapshots/amazonHome-page.html, snapshots/amazonSearch-page.html"
```
...
Use `kits/_base/skills/test-case-parser.md` to parse `testCasesRaw` into structured objects.
...
```json
{
  "appUrl": null,
  "domFiles": [
    { "pageName": "AmazonHomePage",   "file": "snapshots/amazonHome-page.html" },
    { "pageName": "AmazonSearchPage", "file": "snapshots/amazonSearch-page.html" }
  ],
  "strategy": "dom-based",
  "testStyle": "nonbdd",
  "outputDirs": {
