...
(`kits/_base/skills/selector-scorer.md`) to assign a numeric confidence score.
...
1. Read `kits/_base/skills/locator-strategies.md` — apply selector priority rules throughout
