...
(`tc-to-automate/kits/_base/skills/selector-scorer.md`) to assign a numeric confidence score.
...
1. Read `tc-to-automate/kits/_base/skills/locator-strategies.md` — apply selector priority rules throughout
...
7. Inform the user:
   ...
   > your application before running tests. Use `/generate-locators --url <your-app-url>` to
