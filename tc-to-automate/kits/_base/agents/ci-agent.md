...
| `integrations` | object | Contents of `tc-to-automate/configs/integrations.yml` |

---

## Step 1: Load CI skill and template

Read `tc-to-automate/kits/_base/skills/ci-scaffolder.md` — apply patterns throughout.
Load template: `<kitConfig.templates>/ci-github.yml.tmpl` (or provider-specific equivalent).
