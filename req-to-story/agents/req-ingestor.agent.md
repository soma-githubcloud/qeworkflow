...
**Role**: Step 1 of the `/gen-user-stories` pipeline. Accepts one or more requirement
...
Read and apply `req-to-story/skills/req-text-extractor.md` for each file.
...
- Pass `docTypeHint` to `req-analyzer.agent.md` to assist classification
