...
**Role**: Step 2 of the `/gen-user-stories` pipeline. Reads the extracted text from
...
- Non-functional requirements identified here are forwarded to `user-story-writer` for inclusion
  in every generated story's Technical Context section
