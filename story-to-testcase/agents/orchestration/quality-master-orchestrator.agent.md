...
projectName     : string  — from kit.config.json or --project argument
outputBase      : string  — outputs/<projectName>/manual-tests/
testStyle       : string  — "bdd" | "nonbdd" | "both" (from kit.config.json or --style)
...
**Read** `story-to-testcase/skills/tc-formatter-bdd.md` when `testStyle` includes `"bdd"`:
- Input: `01-scenarios/` + `03-gap-filled/` (if exists)
- Output: `manual-tcs/bdd/<feature-name>.feature` — properly tagged per kit BDD rules

**Read** `story-to-testcase/skills/tc-formatter-nonbdd.md` when `testStyle` includes `"nonbdd"`:
...
The upstream orchestrator (`/e2e` command) handles the automation pipeline handoff.
...
When invoking specialist agents, pass these files from this project:

| Phase | Agent file |
|-------|-----------|
| 0 | `story-to-testcase/agents/analysis/user-story-analyzer.agent.md` |
| 1 | `story-to-testcase/agents/orchestration/quality-orchestrator.agent.md` |
| 2 | `story-to-testcase/agents/orchestration/quality-evaluator.agent.md` |
| 3 | `story-to-testcase/agents/analysis/gap-filler.agent.md` |
| 4 | `story-to-testcase/skills/tc-formatter-bdd.md` + `story-to-testcase/skills/tc-formatter-nonbdd.md` |
